          ...
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                ...
                <p className="text-md skillDescription">{item.description}</p>
              </div>
              <div className="linkClass">
                <a className="anchorTag" target="_blank" href={item.gitlink}>
                ...
                {
                  item.live &&
                  <a className="anchorTag" target="_blank" href={item.liveLink}>
                    <p className="text-sm portfolio--link">
                      {item.live}
