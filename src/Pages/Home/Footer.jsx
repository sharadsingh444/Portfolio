  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img className="logofogoimg" src="./img/mylogo.png" alt="Logoipsum" />
        </div>
        <div>
        <p className="footer--content">Made by <a href="https://www.linkedin.com/in/sharad-singh-2a19721a1/" className="footer-anchortag">Sharad</a></p>
        </div>
        <div className="footer--social--icon">
          <ul>
          <li>
              <a
                href="https://www.linkedin.com/in/sharad-singh-2a19721a1/"
            ...
            <li>
              <a
                href="https://www.instagram.com/un_defined_b_oy/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="mailto:sharadsingh3030@gmail.com"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
